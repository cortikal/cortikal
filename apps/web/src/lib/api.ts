...
const HUB_BASE = "https://localhost:5001/hubs";
...
export const ApiClient = {
  ...
  serializeArchMd: async (document: any) => {
...
class AgentHubClient {
  ...
  public onAgentMessage(callback: (message: any) => void) {
    this.connection?.on("ReceiveAgentMessage", callback);
  }

  public offAgentMessage(callback: (message: any) => void) {
